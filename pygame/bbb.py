...
vlevo = False
ball = pygame.image.load('R.png')  # NAČTENÍ OBRÁZKU
...
while running:  # vše co je zde měním dynamicky dle ticku
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            running = False
    ballrot = pygame.transform.rotate(ball, rotation_angle)
    ball_rect = ballrot.get_rect(center=(a, b))


    screen.blit(ballrot, ball_rect)  # vykreslení rotovaného obrázku
